...
class Login extends Component {
  render() {
    return (
      <div style={{ backgroundImage: 'url("bg.jpg")', display: 'flex', height: '100vh', alignItems: 'center', alignContent: 'center', textAlign: 'center', justifyContent: 'center' }}>
        <h1><p style={{ top: '20%', fontFamily: 'Andale Mono' }}>F l a k e</p></h1>
        <p style={{ position: 'absolute', bottom: '27%' }}><input className="btn btn-primary" type="button" onClick={this.logIn} value="Log In with Google" /></p>
      </div>
    )
  }
  logIn() {
